...
import com.example.androidmybroadcastreceiver.databinding.ActivitySmsReceiverBinding
...
class SmsReceiverActivity : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_SMS_NO = "NO_SMS"
        const val EXTRA_SMS_MESSAGE = "MESSAGE_SMS"
    }
